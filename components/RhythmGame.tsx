...
export default function RhythmGame() {
  ...
  return (
    ...
    <div className="fixed inset-0 z-50 overflow-hidden bg-[#121315] font-sans text-white">
      <canvas ref={canvasRef} className="block h-full w-full" />

      {/* 暂停 UI (使用 Tailwind 样式) */}
      {!isPlaying && (
        <div className="pointer-events-auto absolute top-10 right-10 w-72 rounded-xl border border-[#4CE8F7]/50 bg-[#141419]/60 p-6 shadow-[0_0_20px_rgba(76,232,247,0.15)] backdrop-blur-md">
          <h2 className="m-0 mb-5 text-xl font-normal tracking-widest text-[#4CE8F7]">SETTINGS</h2>

          <div className="my-5 text-left">
            <label className="mb-3 flex justify-between text-sm text-gray-300">
              <span>轨道流速</span>
            ...
            <input
              ...
              className="w-full cursor-pointer accent-[#4CE8F7]"
            />
          </div>

          <div className="mt-5 border-t border-white/10 pt-4 text-xs leading-relaxed text-gray-400">
            <p>上下滚动滚轮：查看时间轴</p>
            <p className="mt-1">
              按下 <span className="font-bold text-[#4CE8F7]">P</span> 键恢复运行
            </p>
          </div>
        </div>
      )}
